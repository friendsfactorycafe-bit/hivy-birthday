...
export const siteConfig = {
  ...
  description: "Premium birthday surprise venue in Surat for couples. Romantic birthday decorations, cakes, and private venue celebrations.",
  phone: "+91 9727027278",
...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    metaDescription: "Plan the perfect birthday surprise in Surat at HIVY - Place for Celebrations. Romantic decorations, celebration cake, and intimate private celebration for couples.",
    keywords: [
      ...
      { slug: "birthday-party-places-surat", title: "Birthday Party Places", h1: "Best Birthday Party Places in Surat", metaTitle: "Birthday Party Places Surat | Romantic Venues", metaDescription: "Find the best birthday party places in Surat for couples. HIVY - Place for Celebrations offers private venue celebrations." },
      ...
      { slug: "birthday-date-night-surat", title: "Birthday Date Night", h1: "Romantic Birthday Date Night in Surat", metaTitle: "Birthday Date Night Surat | Romantic Celebration for Couples", metaDescription: "Plan a romantic birthday date night in Surat with private venue setup, decorations, and intimate dinner for couples at HIVY." },
      { slug: "romantic-birthday-dinner-surat", title: "Romantic Birthday Dinner", h1: "Romantic Birthday Dinner in Surat", metaTitle: "Romantic Birthday Dinner Surat | Intimate Dining for Couples", metaDescription: "Celebrate with a romantic birthday dinner in Surat. Private venue, beautiful decorations, and special menu at HIVY." },
      { slug: "private-birthday-celebration-surat", title: "Private Birthday Celebration", h1: "Private Birthday Celebration in Surat", metaTitle: "Private Birthday Celebration Surat | Exclusive Venue for Couples", metaDescription: "Book a private birthday celebration in Surat with 100% privacy, romantic decorations, and premium cake at HIVY private venue." },
      { slug: "intimate-birthday-celebration-surat", title: "Intimate Birthday Celebration", h1: "Intimate Birthday Celebration in Surat", metaTitle: "Intimate Birthday Celebration Surat | Cozy Setup for Couples", metaDescription: "Create an intimate birthday celebration in Surat with cozy decorations, private ambiance, and romantic setup at HIVY." },
      { slug: "birthday-dinner-date-surat", title: "Birthday Dinner Date", h1: "Birthday Dinner Date in Surat", metaTitle: "Birthday Dinner Date Surat | Perfect Evening for Couples", metaDescription: "Plan the perfect birthday dinner date in Surat with candlelit ambiance, delicious food, and romantic setup at HIVY." },
      { slug: "couples-birthday-party-surat", title: "Couples Birthday Party", h1: "Couples Birthday Party in Surat", metaTitle: "Couples Birthday Party Surat | Private Celebration Venue", metaDescription: "Book a couples birthday party in Surat with exclusive decorations, cake, and private venue setup at HIVY." },
      { slug: "birthday-evening-setup-surat", title: "Birthday Evening Setup", h1: "Birthday Evening Setup in Surat", metaTitle: "Birthday Evening Setup Surat | Beautiful Decoration for Couples", metaDescription: "Book a stunning birthday evening setup in Surat with fairy lights, balloons, and romantic ambiance at HIVY." },
      { slug: "luxury-birthday-surprise-surat", title: "Luxury Birthday Surprise", h1: "Luxury Birthday Surprise in Surat", metaTitle: "Luxury Birthday Surprise Surat | Premium Celebration for Couples", metaDescription: "Plan a luxury birthday surprise in Surat with premium decorations, champagne, and exclusive setup at HIVY." },
      { slug: "premium-birthday-celebration-surat", title: "Premium Birthday Celebration", h1: "Premium Birthday Celebration in Surat", metaTitle: "Premium Birthday Celebration Surat | High-End Party for Couples", metaDescription: "Experience a premium birthday celebration in Surat with elegant decorations, photography, and romantic dinner at HIVY." },
      { slug: "birthday-date-ideas-surat", title: "Birthday Date Ideas", h1: "Best Birthday Date Ideas in Surat", metaTitle: "Birthday Date Ideas Surat | Romantic Celebration Options", metaDescription: "Discover the best birthday date ideas in Surat for couples. Romantic setups, private venues, and memorable celebrations at HIVY." },
      { slug: "special-birthday-date-surat", title: "Special Birthday Date", h1: "Special Birthday Date in Surat", metaTitle: "Special Birthday Date Surat | Unforgettable Experience for Couples", metaDescription: "Plan a special birthday date in Surat with unique decorations, private dining, and romantic setup at HIVY." },
      { slug: "exclusive-birthday-celebration-surat", title: "Exclusive Birthday Celebration", h1: "Exclusive Birthday Celebration in Surat", metaTitle: "Exclusive Birthday Celebration Surat | VIP Experience for Couples", metaDescription: "Book an exclusive birthday celebration in Surat with VIP treatment, premium decorations, and private ambiance at HIVY." },
      { slug: "birthday-setup-for-couples-surat", title: "Birthday Setup for Couples", h1: "Birthday Setup for Couples in Surat", metaTitle: "Birthday Setup for Couples Surat | Romantic Decoration", metaDescription: "Get the perfect birthday setup for couples in Surat with heart-shaped balloons, flowers, and candlelit ambiance at HIVY." },
      { slug: "romantic-birthday-setup-surat", title: "Romantic Birthday Setup", h1: "Romantic Birthday Setup in Surat", metaTitle: "Romantic Birthday Setup Surat | Dreamy Decoration for Couples", metaDescription: "Create a romantic birthday setup in Surat with rose petals, fairy lights, and intimate ambiance at HIVY." },
      { slug: "birthday-venue-for-couples-surat", title: "Birthday Venue for Couples", h1: "Best Birthday Venue for Couples in Surat", metaTitle: "Birthday Venue for Couples Surat | Private & Romantic", metaDescription: "Find the best birthday venue for couples in Surat. HIVY offers a private venue with romantic decorations and celebration packages." },
      { slug: "budget-birthday-surprise-surat", title: "Budget Birthday Surprise", h1: "Budget Birthday Surprise in Surat", metaTitle: "Budget Birthday Surprise Surat | Affordable Celebration", metaDescription: "Plan a budget-friendly birthday surprise in Surat without compromising on romance. Affordable packages at HIVY." },
      { slug: "affordable-birthday-celebration-surat", title: "Affordable Birthday Celebration", h1: "Affordable Birthday Celebration in Surat", metaTitle: "Affordable Birthday Celebration Surat | Value Packages for Couples", metaDescription: "Celebrate with affordable birthday packages in Surat. Romantic setups, decorations, and cake at budget prices at HIVY." },
      { slug: "perfect-birthday-date-surat", title: "Perfect Birthday Date", h1: "Plan the Perfect Birthday Date in Surat", metaTitle: "Perfect Birthday Date Surat | Memorable Experience for Couples", metaDescription: "Plan the perfect birthday date in Surat with everything arranged - decorations, food, and romantic ambiance at HIVY." },
      { slug: "birthday-decoration-for-couples-surat", title: "Birthday Decoration for Couples", h1: "Birthday Decoration for Couples in Surat", metaTitle: "Birthday Decoration for Couples Surat | Heart & Balloon Setup", metaDescription: "Beautiful birthday decoration for couples in Surat with heart-shaped balloons, flowers, and romantic themes at HIVY." },
      { slug: "surprise-birthday-decoration-surat", title: "Surprise Birthday Decoration", h1: "Surprise Birthday Decoration in Surat", metaTitle: "Surprise Birthday Decoration Surat | Stunning Setup", metaDescription: "Get stunning surprise birthday decoration in Surat with balloons, flowers, and fairy lights at HIVY private venue." },
      { slug: "birthday-party-for-two-surat", title: "Birthday Party for Two", h1: "Birthday Party for Two in Surat", metaTitle: "Birthday Party for Two Surat | Intimate Couple Celebration", metaDescription: "Celebrate birthday party for two in Surat with private setup, romantic dinner, and exclusive ambiance at HIVY." },
      { slug: "birthday-experience-surat", title: "Birthday Experience", h1: "Unforgettable Birthday Experience in Surat", metaTitle: "Birthday Experience Surat | Premium Celebration for Couples", metaDescription: "Create an unforgettable birthday experience in Surat with 3-hour private celebration, decorations, and romance at HIVY." },
      { slug: "birthday-private-venue-surat", title: "Birthday Private Venue", h1: "Birthday Private Venue in Surat", metaTitle: "Birthday Private Venue Surat | 100% Privacy for Couples", metaDescription: "Book a birthday private venue in Surat with complete privacy, romantic decorations, and intimate celebration at HIVY." },
      { slug: "first-birthday-together-surat", title: "First Birthday Together", h1: "Celebrate First Birthday Together in Surat", metaTitle: "First Birthday Together Surat | New Couple Celebration", metaDescription: "Make your first birthday together special in Surat. Romantic setup, decorations, and memorable moments at HIVY." },
      { slug: "birthday-dinner-restaurant-surat", title: "Birthday Dinner Restaurant", h1: "Best Birthday Dinner Restaurant in Surat", metaTitle: "Birthday Dinner Restaurant Surat | Romantic Dining for Couples", metaDescription: "Find the best birthday dinner restaurant in Surat for couples. Private venue dining with romantic setup at HIVY." },
      { slug: "birthday-surprise-ideas-surat", title: "Birthday Surprise Ideas", h1: "Best Birthday Surprise Ideas in Surat", metaTitle: "Birthday Surprise Ideas Surat | Creative Celebration Options", metaDescription: "Discover creative birthday surprise ideas in Surat for your partner. Unique setups and romantic celebrations at HIVY." },
      { slug: "birthday-celebration-ideas-surat", title: "Birthday Celebration Ideas", h1: "Birthday Celebration Ideas in Surat", metaTitle: "Birthday Celebration Ideas Surat | Romantic Options for Couples", metaDescription: "Get the best birthday celebration ideas in Surat for couples. Romantic dinners, surprise parties, and more at HIVY." },
      { slug: "birthday-planning-surat", title: "Birthday Planning", h1: "Birthday Planning Services in Surat", metaTitle: "Birthday Planning Surat | Professional Party Organizers", metaDescription: "Expert birthday planning services in Surat for couples. We handle decorations, setup, and everything at HIVY." },
      { slug: "birthday-organizers-surat", title: "Birthday Organizers", h1: "Best Birthday Organizers in Surat", metaTitle: "Birthday Organizers Surat | Professional Event Planners", metaDescription: "Hire the best birthday organizers in Surat for couple celebrations. Complete planning and setup at HIVY." },
      { slug: "birthday-theme-decoration-surat", title: "Birthday Theme Decoration", h1: "Birthday Theme Decoration in Surat", metaTitle: "Birthday Theme Decoration Surat | Custom Themes for Couples", metaDescription: "Get stunning birthday theme decoration in Surat with customized themes, colors, and romantic setups at HIVY." },
      { slug: "birthday-special-package-surat", title: "Birthday Special Package", h1: "Birthday Special Package in Surat", metaTitle: "Birthday Special Package Surat | All-Inclusive Celebration", metaDescription: "Book birthday special package in Surat with decorations, cake, dinner, and photography included at HIVY." },
      { slug: "birthday-cake-celebration-surat", title: "Birthday Cake Celebration", h1: "Birthday Cake Celebration in Surat", metaTitle: "Birthday Cake Celebration Surat | Cake Cutting Setup for Couples", metaDescription: "Celebrate with birthday cake cutting in Surat. Beautiful setup, decorations, and romantic ambiance at HIVY." }
    ]
  }
];
...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaDescription: "Looking for birthday surprise ideas in Surat? Discover 10 creative ways to surprise your partner, from romantic dinners to midnight celebrations.",
  ...
  },
  {
    ...
    metaDescription: "Need date night inspiration in Surat? Discover romantic ideas from candlelit dinners to stargazing experiences for couples.",
  ...
  },
  {
    ...
    excerpt: "Stunning pre-wedding photoshoot locations in Surat including gardens, heritage sites, and scenic spots.",
    metaTitle: "Best Pre-Wedding Photoshoot Locations Surat 2026",
    metaDescription: "Planning your pre-wedding shoot in Surat? Discover the best locations from gardens to heritage sites for stunning photos.",
  ...
  },
  {
    ...
    metaDescription: "Looking for Valentine's Day ideas in Surat? Discover romantic date plans from candlelight dinners to surprise celebrations.",
...
export function getAreaMetaDescription(area: AreaConfig): string {
  return `Plan the perfect birthday surprise in ${area.name}, Surat at HIVY - Place for Celebrations. Romantic decorations, celebration cake, and private venue for couples.`;
}
