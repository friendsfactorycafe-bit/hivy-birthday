...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    keywords: [
      ...
      { slug: "birthday-date-night-surat", title: "Birthday Date Night", h1: "Romantic Birthday Date Night in Surat", metaTitle: "Birthday Date Night Surat | Romantic Celebration for Couples", metaDescription: "Plan a romantic birthday date night in Surat with private rooftop setup, decorations, and intimate dinner for couples at HIVY." },
      { slug: "romantic-birthday-dinner-surat", title: "Romantic Birthday Dinner", h1: "Romantic Birthday Dinner in Surat", metaTitle: "Romantic Birthday Dinner Surat | Intimate Dining for Couples", metaDescription: "Celebrate with a romantic birthday dinner in Surat. Private rooftop venue, beautiful decorations, and special menu at HIVY." },
      { slug: "private-birthday-celebration-surat", title: "Private Birthday Celebration", h1: "Private Birthday Celebration in Surat", metaTitle: "Private Birthday Celebration Surat | Exclusive Venue for Couples", metaDescription: "Book a private birthday celebration in Surat with 100% privacy, romantic decorations, and premium cake at HIVY rooftop venue." },
      ...
      { slug: "birthday-rooftop-celebration-surat", title: "Birthday Rooftop Celebration", h1: "Birthday Rooftop Celebration in Surat", metaTitle: "Birthday Rooftop Celebration Surat | Open Air Private Party", metaDescription: "Celebrate birthday on a beautiful rooftop in Surat with fairy lights, decorations, and romantic ambiance at HIVY." },
      { slug: "couples-birthday-party-surat", title: "Couples Birthday Party", h1: "Couples Birthday Party in Surat", metaTitle: "Couples Birthday Party Surat | Private Celebration Venue", metaDescription: "Book a couples birthday party in Surat with exclusive decorations, cake, and private rooftop setup at HIVY." },
      ...
      { slug: "birthday-dinner-restaurant-surat", title: "Birthday Dinner Restaurant", h1: "Best Birthday Dinner Restaurant in Surat", metaTitle: "Birthday Dinner Restaurant Surat | Romantic Dining for Couples", metaDescription: "Find the best birthday dinner restaurant in Surat for couples. Private rooftop dining with romantic setup at HIVY." },
